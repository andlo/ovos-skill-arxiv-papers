...
setup(
    name=PYPI_NAME,
    version=get_version(),
    description="Reads arXiv paper abstracts aloud - provider skill for ovos-common-reading-pipeline-plugin",
    ...
    keywords="ovos skill voice assistant arxiv science research papers",
